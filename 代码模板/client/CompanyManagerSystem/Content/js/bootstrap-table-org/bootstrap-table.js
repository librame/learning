...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        responseHandler: function (res) { //·µ»ØÖµ
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('Showing <span style=\'color:#28a4c9\'> %s </span> to <span style=\'color:#28a4c9\'>%s </span> of %s rows', pageFrom, pageTo, totalRows);
        },
